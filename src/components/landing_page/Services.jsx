...
import { musicLabServices, musciLabServicesIcons } from "../../constants";
import {
  PhotoChatMessage,
  Gradient,
  VideoChatMessage,
  ...
  return (
    <Section id="how-to-use">
      <div className="container">
        <Heading
          title="Transform Ideas into Music Together."
          text="Transforming Music Creation with Virtual Collaboration."
        />
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[15rem] ml-auto">
              ...
              <ul className="body-2">
                {musicLabServices.map((item, index) => (
                  <li
                    key={index}
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                ...
                <ul className="flex items-center justify-between">
                  {musciLabServicesIcons.map((item, index) => (
                    <li
                      key={index}
