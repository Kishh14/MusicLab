...
function DrumKit() {
    ...
    return (
        <div className="py-5 bg-black rounded-lg" style={{ position: 'relative', height: "550px" }}>

            <div className="flex justify-between">
                <div className="voltage-button" style={{ margin: '10px 0 0 25px' }}>
                    <button onClick={() => setIsDrumkitActivated(!isDrumkitActivated)}>{isDrumkitActivated ? 'Deactivate' : 'Activate'}</button>
            ...
            <div className="flex justify-center">
                ...
                <img onClick={() => play('tomDrumRight')} src={tomDrum} alt="" style={{ width: '135px', objectFit: "contain" }} />
                <img onClick={() => play('rideCymbalRight')} src={rideCymbalRight} alt="" style={{ width: '170px' }} />
            </div>
            <div className="flex justify-center">
                <img onClick={() => play('highHat')} src={highHat} className="" alt="" style={{ width: '150px', position: 'absolute', top: '30%', left: '24%' }} />
                <img onClick={() => play('bassDrum')} src={bassDrum} className="bassDrum" alt="" style={{ width: '220px', position: 'absolute', top: '35%', }} />
                <img onClick={() => play('highHatRight')} src={highHatRight} className="" alt="" style={{ width: '150px', position: 'absolute', top: '30%', left: '60%' }} />
            </div>
            <div className="flex justify-center">
                <img onClick={() => play('snareDrumLeft')} src={snareDrum} className="" alt="" style={{ width: '144px', position: 'absolute', top: '55%', left: '30%' }} />
                <img onClick={() => play('snareDrumRight')} src={snareDrum} className="" alt="" style={{ width: '144px', position: 'absolute', top: '55%', left: '56%' }} />
            </div>
        </div>
    );
}
